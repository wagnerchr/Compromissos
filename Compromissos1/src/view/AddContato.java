...
// Adicionar Contato
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String nome, data_nascS, endereco;
            // Date data_nasc;
            ...
            Contato contato = new Contato(nome, endereco, data_nasc);
    ...
    private void InsereContatoBanco(Contato contato) {
        
        // nome, data_nasc, endereco
        String query = "insert into contato() values(?,?,?,?)";
        ...
        try {
            ...
            /*
            ContatoConnection connection = new ContatoConnection();
            ResultSet rs = connection.autenticacao(contato); 
*/
